...
class AdaptiveSampler(Sampler):
    ...
    def __init__(self, task, plan_size, step_size=8):
        super(AdaptiveSampler, self).__init__(task, plan_size)
    ...
    def sample(self, samples, dims, threshold=2.5, valid_dims=2):
        ...
        adaptive_range = np.arange(self.step_size, self.plan_size+1, self.step_size)
